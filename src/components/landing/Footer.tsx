        ...
        <div style={{
          ...
          <div style={{ flex: "1 1 280px", minWidth: 200 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
              ...
              <span style={{ fontSize: 16, fontWeight: 700, color: "#e2e8f0", letterSpacing: "0.04em" }}>HIRELY</span>
            </div>
            <p style={{ fontSize: 13, color: "#64748b", lineHeight: 1.7, maxWidth: 280, marginBottom: 20 }}>
              AI-powered mock interview platform that helps you practice, improve, and land your dream job.
            </p>
            {/* Social links */}
