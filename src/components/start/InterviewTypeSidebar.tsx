...
export function InterviewTypeSidebar({ selected, onSelect }: Props) {
  return (
    <aside className="flex flex-col gap-3">
      <span className="label-caps mb-2 block text-slate-400/90">Interview Type</span>
        ...
        return (
          <button
            ...
            className={`rounded-2xl border p-4 text-left backdrop-blur-md transition-all duration-200 ${
              isActive
                ? "border-cyan-400/35 bg-gradient-to-br from-cyan-500/[0.12] to-violet-600/[0.08] shadow-[0_0_28px_-6px_rgba(34,211,238,0.25)]"
