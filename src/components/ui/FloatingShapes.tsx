  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
      <div
        ...
        style={{
          background: `radial-gradient(circle, var(--lp-orb-a) 0%, transparent 70%)`,
          filter: "blur(48px)",
        }}
      />
      <div
        ...
        style={{
          background: `radial-gradient(circle, var(--lp-orb-b) 0%, transparent 70%)`,
          filter: "blur(52px)",
        }}
      />
      <div
        ...
        style={{
          background: `radial-gradient(circle, var(--lp-orb-c) 0%, transparent 68%)`,
          filter: "blur(40px)",
        }}
      />
    </div>
